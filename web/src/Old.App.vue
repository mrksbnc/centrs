	...
	<div :class="[
		...
		<nav :class="[
			...
			<div class="flex items-center space-x-6">
				...
				<button @click="toggleDarkMode" class="ml-4 w-10 h-6 relative rounded-full flex items-center border"
		...
		<footer :class="[
			...
			<div class="container mx-auto px-6 flex justify-between items-center">
				...
				<div :class="[
					...
					<div :class="[darkMode ? 'bg-white' : 'bg-black', 'w-4 h-4 transition-colors duration-500']"></div>
				</div>
			</div>
		</footer>
	</div>
